...
export function Research() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="bg-white dark:bg-slate-950 transition-colors duration-300 pointer-events-none select-none opacity-80">
        <Helmet>
        ...
        <section className="section-padding bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 text-center relative overflow-hidden" aria-label="Field Prototypes Access">
          ...
          <div className="container-wide relative z-10">
            ...
            <div 
              className="inline-flex px-8 py-4 bg-brand-jade text-white font-bold rounded-xl hover:bg-[#005a62] transition-colors items-center gap-3 shadow-xl shadow-brand-jade/20 outline-none group"
            >
