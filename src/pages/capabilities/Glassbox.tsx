...
export default function Glassbox() {
  const tags = ["DATA INTEGRATION", "TRANSPARENCY", "IRC § 7216 COMPLIANCE"];
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-24 p-6 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-2 text-sm text-slate-600 dark:text-slate-400">
                    <div className="w-1.5 h-1.5 bg-brand-jade rounded-full shrink-0 mt-1.5" />
                    <span>Ensures civic tech deployments can map cross-enrollment data securely without exposing raw tax records to unauthorized nodes.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 prose prose-slate dark:prose-invert max-w-none">
              <div className="mb-12">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-black m-0">Human-in-the-Loop Adjudication</h3>
                </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400 mt-4">
                  This approach aligns civic tech ideals of human-centered service design with the rigorous evidentiary requirements of federal oversight, proving that system security and citizen accessibility are not mutually exclusive.
                </p>
              </div>
            </div>
          </div>
