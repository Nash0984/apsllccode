            ...
            <div className="lg:col-span-8 prose prose-slate dark:prose-invert max-w-none">
              <div className="mb-12">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-black m-0 tracking-tight text-slate-900 dark:text-white">{t('capabilitiesPage.subPages.sanction.section1.title')}</h3>
                </div>
              ...
              <div className="mb-12">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-black m-0 tracking-tight text-slate-900 dark:text-white">{t('capabilitiesPage.subPages.sanction.section2.title')}</h3>
                </div>
                <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
