  ...
  if (embedded) {
    return (
      <div className="relative group">
        ...
        <div className="flex flex-col h-[600px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] overflow-hidden shadow-2xl opacity-50 select-none pointer-events-none">
    ...
    <>
      <AnimatePresence>
        {isOpen && !isMinimized && (
          ...
          >
            <div className="absolute inset-0 z-[60] pointer-events-none overflow-hidden rounded-[2rem]">
              <UnderDevelopmentOverlay />
            </div>
            
            <div className="opacity-50 select-none pointer-events-none flex-1 flex flex-col">
